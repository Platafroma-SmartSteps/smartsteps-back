...
public class Carteirinha {
    @Id
    @Column(name = "id_carterinha",length=36,nullable=false)
    ...
    public Carteirinha(String idCarterinha, String cpfCarterinha, String nomeInstituicao, Date dataEmissao,
    ...
    public String getIdCarterinha() {
        return idCarterinha;
    }

    public void setIdCarterinha(String idCarterinha) {
        this.idCarterinha = idCarterinha;
    }
